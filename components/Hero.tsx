...
export function Hero() {
  ...
  return (
    <section className="section-noise relative overflow-hidden pt-28 pb-16 md:pt-32 md:pb-24 lg:min-h-[92vh] lg:pt-36">
      ...
      <div className="container-premium relative z-10 grid items-center gap-12 lg:grid-cols-[9fr_11fr] lg:gap-8 xl:gap-12">
        <div className="max-w-xl">
          <motion.p
            initial={reduce ? false : { opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="mb-4 text-xs font-semibold tracking-[0.28em] text-gold uppercase"
          >
          ...
          <motion.h1
            ...
            className="font-display text-[2.65rem] leading-[0.95] font-black tracking-tight text-white uppercase sm:text-6xl md:text-7xl"
          >
