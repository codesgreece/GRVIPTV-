...
export function HeroVisual() {
  return (
    <div className="hero-visual-composition relative mx-auto w-full max-w-[820px] lg:max-w-none">
      ...
      <div className="relative aspect-[16/11] w-full min-h-[340px] sm:min-h-[400px] md:aspect-[16/10.5] md:min-h-[460px] lg:min-h-[520px] xl:min-h-[580px]">
        <MiniScreenWall />
        <CinematicTV />
        <GoldenWave />
      </div>
